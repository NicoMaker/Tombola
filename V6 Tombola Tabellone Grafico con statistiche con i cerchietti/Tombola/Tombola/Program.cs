...
List<int> Tentativi = new List<int>();
...
do
{
    ...
    switch(scelta)
    {
        case 1:
            ...
            Tombola.ParteHTML(numeri_ordinati);
            Console.WriteLine("");
            break;
        case 2:
            Console.Clear();
        ...
        case 3:
            Console.Clear();
            Console.WriteLine(" ");
            Tombola.Controllo(numero_passaggio,numeri, numeri_ordinati, numero);
            Console.WriteLine(" ");
            break;
        case 4:
            Console.Clear();
            Console.WriteLine(" ");
            Tentativi.Add(numero_passaggio + 1);
...
void Statistiche(List <int> Tentativi)
{
    float somma = 0;
    ...
    for (int i = 0; i < Tentativi.Count; i++)
    {
        Console.WriteLine($"nella {i + 1} partita sono serviti --> {Tentativi[i]} tentativi");
        somma += Tentativi[i];
    }

    Console.WriteLine("");
    Console.WriteLine($"in media per finire una partita sono serviti ---> {somma / Tentativi.Count} tentativi ");
}